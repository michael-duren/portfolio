...
const portfolioList: PortfolioItem[] = [
  {
    title: "Next Step CMS",
    description: [
      "A SaaS platform serving 1,200+ users across chemical dependency treatment facilities in California State programs and drug testing labs, generating $4,000 monthly revenue.",
